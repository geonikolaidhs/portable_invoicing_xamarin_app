...
namespace ITS.WRM.SFA.Droid.Pages.SettingsChiledViews
{
    ...
    public partial class VersioningPage : ContentPage
    {
        ...
        {
            return await DependencyService.Get<ICrossPlatformMethods>().GetServerMaxVersionAsync(type.Name, Timeout);
        }
        ...
        protected async void OnEdit(object sender, EventArgs args)
        {
